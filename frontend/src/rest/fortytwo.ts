import { FortyTwoCursusUserDetails } from '../../../backend/src/types/fortytwo/FortyTwoCursusUserDetails';
import { FortyTwoOauthToken } from '../../../backend/src/types/fortytwo/FortyTwoOauthToken';
